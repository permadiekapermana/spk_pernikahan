...
<div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'>
    ...
    <table id='example4' class='table table-striped table-bordered' style='width:100%'>
        ...
        echo"
            <tr>
                ...
                <td>$r[harga]</td>
                <td>
                <a href='?module=paket_user&act=detailpaket&id=$r[id_paket] 'class='btn btn-success btn-xs'><i class='fa fa-pencil'></i> Detail</a>
                </td>
            </tr>";
						$no++;						
	        }
  ...
  <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'>
    ...
    <h5 class='card-header'>Edit Paket</h5>
      ...
      <form method='POST' action='$aksi?module=paket&act=update'>
      <div class='col-md-6'>
          <label for='id_paket' class='col-form-label'>Kode Paket</label>
      ...
      <div class='col-md-6'>
          ...
          <input id='harga' value='$r[harga]' name='harga' type='text' class='form-control' required>
      </div>  <br>
      <div class='col-md-6'>  
