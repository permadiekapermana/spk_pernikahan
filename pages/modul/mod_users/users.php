    ...
    <h5 class='card-header'>Tambah User</h5>
      ...
      <div class='col-md-6'>
        ...
        <label class='custom-control custom-radio custom-control-inline'>
          <input type='radio' name='level' checked='' value='Admin' class='custom-control-input'><span class='custom-control-label'>Admin</span>
        </label>
        <label class='custom-control custom-radio custom-control-inline'>
          <input type='radio' name='level' value='Pelanggan' class='custom-control-input'><span class='custom-control-label'>Pelanggan</span>
        </label>
      </div>
      <br>
      <div class='col-md-6'>
