...
<head>
    ...
    <title>SPK Pemilihan Paket Pernikahan - Sumber Ayu Salon</title>
</head>
...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            ...
            <a href="?module=dashboard"><img class="logo-img" src="../assets/images/favicon.jpg" width="5%" hspace="100" alt="logo"></a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-database"></i>Data Master <span class="badge badge-success">6</span></a>
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">                                        
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="?module=kriteria">Data Kriteria</a>
                                        </li> 
                                        <li class="nav-item">
                                            <a class="nav-link" href="?module=bobot">Data Bobot</a>
                                        </li>                                        
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fas fa-heart"></i>Data Paket Pernikahan</a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="?module=kategori">Data Kategori <span class="badge badge-secondary">New</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="?module=produk">Data Produk</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="?module=paket">Data Paket Pernikahan</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="?module=nilai"><i class="fas fa-calculator"></i> Penilaian Paket Pernikahan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="?module=rekomendasi"><i class="fas fa-square"></i> Rekomendasi Paket Pernikahan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="?module=analisis"><i class="fas fa-circle"></i> Analisis Paket Pernikahan</a>
                            </li>  
                            <!-- <li class="nav-item">
                                <a class="nav-link" href="?module=laporan"><i class="fas fa-file-alt"></i> Laporan Hasil Analisis</a>
                            <li> -->
                            <?php } elseif ($_SESSION['leveluser']=='Pelanggan' ){ ?> 
                                <li class="nav-divider">
                                Menu
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="?module=paket_user"><i class="fas fa-heart"></i> Paket Pernikahan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="?module=rekomendasi_user"><i class="fas fa-calculator"></i> Rekomendasi Paket Pernikahan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="?module=analisis"><i class="fas fa-calculator"></i> Analisis Paket Pernikahan</a>
                            </li>  
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2020 Concept. All rights reserved. Created by <a href="#" target='_blank'>Indra Purnama</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
