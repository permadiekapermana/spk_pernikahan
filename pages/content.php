...
elseif ($_GET['module']=='paket_user'){
  if ($_SESSION['leveluser']=='Pelanggan'){
  include "modul/mod_paket/paket_user.php";
  }
}
...
elseif ($_GET['module']=='rekomendasi_user'){
  if ($_SESSION['leveluser']=='Pelanggan'){
  include "modul/mod_rekomendasi/rekomendasi_user.php";
  }
}
